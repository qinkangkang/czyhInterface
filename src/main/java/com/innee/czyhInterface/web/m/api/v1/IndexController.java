...
@RestController("M_API_V1_IndexController")
@RequestMapping(value = "/m/api/index", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class IndexController {
	...
	@PostMapping(value = "/getAllChannel")
	...
	@PostMapping(value = "/getChannelSliderList")
