...
@RestController("M_API_V1_SceneUserController")
@RequestMapping(value = "/m/api/sceneUser", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class SceneUserController {
	...
	@PostMapping(value = "/getSceneUserInfo")
