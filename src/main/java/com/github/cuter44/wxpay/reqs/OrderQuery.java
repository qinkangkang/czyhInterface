...
public class OrderQuery extends WxpayRequestBase {
	...
	public static final List<String> KEYS_PARAM_NAME = Arrays.asList("appid", "mch_id", "nonce_str", "out_trade_no",
			"transaction_id", "sign");
	...
	// SIGN
	@Override
	public OrderQuery sign() throws UnsupportedEncodingException {
	...
	// EXECUTE
	@Override
	public OrderQueryResponse execute() throws WxpayException, WxpayProtocolException, IOException {
