...
public class RefundQueryResponse extends WxpayResponseBase {
	...
	public static List<String> KEYS_PARAM_NAME_TEMPLATE = Arrays.asList("appid", "cash_fee",
			"coupon_refund_batch_id_$0_$1", "coupon_refund_count_$0", "coupon_refund_fee_$0", "coupon_refund_fee_$0_$1",
			"coupon_refund_id_$0_$1", "device_info", "err_code", "err_code_des", "fee_type", "mch_id", "nonce_str",
			"out_refund_no_$0", "out_trade_no", "refund_channel_$0", "refund_count", "refund_fee", "refund_fee_$0",
			"refund_id_$0", "refund_status_$0", "result_code", "return_code", "return_msg", "sign", "total_fee",
			"transaction_id");
	...
	public RefundQueryResponse(InputStream respXml) throws IOException {
		super(respXml);
	...
	@Override
	protected boolean verifySign(Properties conf) throws UnsupportedEncodingException {
		return (super.verifySign(this.getKeysParamName(), conf));
	}

	// PROPERTY
	// REFUND_COUND
	public final int getRefundCount() {
		return Integer.valueOf(super.getProperty(KEY_REFUND_COUNT));
	}

	// REFUND_ID
	public String getRefundId(int n) {
		return (super.getProperty(materializeParamName(KEY_REFUND_ID_$0, n)));
	}
	...
	public String getOutRefundNo(int n) {
		return (super.getProperty(materializeParamName(KEY_OUT_REFUND_NO_$0, n)));
	}
	...
	public RefundStatus getRefundStatus(int n) {
		return (RefundStatus.valueOf(super.getProperty(materializeParamName(KEY_REFUND_STATUS_$0, n))));
	}
	...
	public Integer getRefundFee(int n) {
		return (super.getIntProperty(materializeParamName(KEY_REFUND_FEE_$0, n)));
	}
	...
	public final Integer getCouponRefundFee(int n) {
		return (super.getIntProperty(materializeParamName(KEY_COUPON_REFUND_FEE_$0, n)));
	}
	...
	public Integer getCouponRefundCount(int n) {
		return (super.getIntProperty(materializeParamName(KEY_COUPON_REFUND_COUNT_$0, n)));
	}
