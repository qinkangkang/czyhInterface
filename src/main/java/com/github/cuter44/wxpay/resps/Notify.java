...
public class Notify extends WxpayResponseBase {
	...
	public static List<String> KEYS_PARAM_NAME_TEMPLATE = Arrays.asList("appid", "attach", "bank_type", "cash_fee",
			"cash_fee_type", "coupon_count", "coupon_fee", "coupon_fee_$0", "coupon_id_$0", "device_info", "err_code",
			"err_code_des", "fee_type", "is_subscribe", "mch_id", "nonce_str", "openid", "out_trade_no", "result_code",
			"return_code", "return_msg", "sign", "time_end", "total_fee", "trade_type", "transaction_id");
	...
	public Notify(InputStream notifyXml) throws IOException {
		super(notifyXml);
