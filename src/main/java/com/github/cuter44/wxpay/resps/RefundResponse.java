...
public class RefundResponse extends WxpayResponseBase {
	...
	public static final List<String> KEYS_PARAM_NAME_TEMPLATE = Arrays.asList("appid", "cash_fee", "cash_refund_fee",
			"coupon_refund_count", "coupon_refund_fee", "coupon_refund_fee_$0", "coupon_refund_id_$0", "device_info",
			"err_code", "err_code_des", "fee_type", "mch_id", "nonce_str", "out_refund_no", "out_trade_no",
			"refund_channel", "refund_fee", "refund_id", "result_code", "return_code", "return_msg", "sign",
	...
	public RefundResponse(InputStream respXml) throws IOException {
		super(respXml);
	...
	public String getRefundId() {
		return (super.getProperty(KEY_REFUND_ID));
	}
	...
	public Integer getRefundFee() {
		return (super.getIntProperty(KEY_REFUND_FEE));
	}
	...
	public Integer getCashRefundFee() {
		return (super.getIntProperty(KEY_CASH_REFUND_FEE));
	}
	...
	public Integer getCouponRefundFee() {
		return (super.getIntProperty(KEY_COUPON_REFUND_FEE));
	}

	public final Integer getCouponRefundCount() {
		return (super.getIntProperty(KEY_COUPON_REFUND_COUNT));
	}
