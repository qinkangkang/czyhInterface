...
import com.github.cuter44.wxpay.constants.TradeState;
...
public class OrderQueryResponse extends WxpayResponseBase {
	...
	public static List<String> KEYS_PARAM_NAME_TEMPLATE = Arrays.asList("appid", "attach", "bank_type", "cash_fee",
			"cash_fee_type", "coupon_batch_id_$0", "coupon_count", "coupon_fee", "coupon_fee_$0", "coupon_id_$0",
			"device_info", "err_code", "err_code_des", "fee_type", "is_subscribe", "mch_id", "nonce_str", "openid",
			"out_trade_no", "result_code", "return_code", "return_msg", "sign", "time_end", "total_fee", "trade_state",
	...
	public OrderQueryResponse(InputStream respXml) throws IOException {
		super(respXml);
	...
	public TradeState getTradeState() {
		return (TradeState.valueOf(super.getProperty(KEY_TRADE_STATE)));
	}

	// TIME
	public Date getTimeEnd() {
		return (super.getDateProperty(KEY_TIME_END));
	}
	...
	public final Double getTotalFeeYuan() {
		...
		return (fen != null ? (fen.doubleValue() / 100.0) : null);
	}
