...
import com.github.cuter44.wxmp.resps.GroupsMembersBatchupdateResponse;

/**
 * 批量移动用户分组 <br />
 * <a href=
 * "http://mp.weixin.qq.com/wiki/0/56d992c605a97245eb7e617854b169fc.html#.E5.88.9B.E5.BB.BA.E5.88.86.E7.BB.84">
 * ref ↗</a> <br />
 * 
 ...
 * </pre>
 * 
 * ADDITIONAL NOTE: <code>openid_list</code> is set via setOpenidList, not via
 * setPrperty(since poor performance to parse array from Properties)
 */
public class GroupsMembersBatchupdate extends WxmpRequestBase {
	...
	public static final JSONObject BODY_SCHEMA = JSON
			.parseObject("{" + "'properties':{" + "'to_groupid':{'type':'string'}" + "} }");
	...
	// EXECUTE
	@Override
	public GroupsMembersBatchupdateResponse execute() throws IOException {
