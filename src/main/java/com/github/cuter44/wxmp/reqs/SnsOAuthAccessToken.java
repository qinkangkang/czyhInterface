...
public class SnsOAuthAccessToken extends WxmpRequestBase {
	// KEYS
	protected static final List<String> KEYS_PARAM = Arrays.asList("appid", "secret", "code", "grant_type");
	...
	public SnsOAuthAccessToken(String appid, String secret, String code) {
		...
		super.setProperty(KEY_APPID, appid).setProperty(KEY_SECRET, secret).setProperty(KEY_CODE, code)
	...
	// EXECUTE
	@Override
	public SnsOAuthAccessTokenResponse execute() throws IOException {
