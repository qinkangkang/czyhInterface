 ...
 * 获取access token <br />
 * <a href=
 * "http://mp.weixin.qq.com/wiki/11/0e4b294685f817b95cbed85ba5e82b8f.html">ref
 * ↗</a> <br />
 * 
...
public class TokenClientCredential extends WxmpRequestBase {
	// KEYS
	protected static final List<String> KEYS_PARAM = Arrays.asList("grant_type", "appid", "secret");
	...
	public TokenClientCredential(Properties prop) {
		...
		if (super.getProperty(KEY_SECRET) == null)
			super.setProperty(KEY_SECRET, super.getProperty("SECRET"));
	...
	public TokenClientCredential(String appid, String secret) {
		...
		super.setProperty("grant_type", "client_credential").setProperty(KEY_APPID, appid).setProperty(KEY_SECRET,
				secret);
	...
	// EXECUTE
	@Override
	public TokenClientCredentialResponse execute() throws IOException {
