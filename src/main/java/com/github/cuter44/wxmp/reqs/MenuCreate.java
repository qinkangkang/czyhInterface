...
import com.github.cuter44.wxmp.resps.MenuCreateResponse;

/**
 * 自定义菜单创建接口 <br />
 * <a href=
 * "http://mp.weixin.qq.com/wiki/13/43de8269be54a0a6f64413e4dfa94f39.html">ref
 * ↗</a>
 */
public class MenuCreate extends WxmpRequestBase {
	...
	// EXECUTE
	@Override
	public MenuCreateResponse execute() throws IOException {
