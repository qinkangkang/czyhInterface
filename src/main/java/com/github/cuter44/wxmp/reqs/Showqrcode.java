 ...
 * 通过ticket换取二维码 <br />
 * <a href=
 * "http://mp.weixin.qq.com/wiki/18/28fc21e7ed87bec960651f0ce873ef8a.html#.E9.80.9A.E8.BF.87ticket.E6.8D.A2.E5.8F.96.E4.BA.8C.E7.BB.B4.E7.A0.81">
 * ref ↗</a> <br />
 * (No specification provided in official wiki)
 */
public class Showqrcode extends WxmpRequestBase {
	// KEYS
	protected static final List<String> KEYS_PARAM = Arrays.asList("ticket");
	...
	@Override
	public String toURL() {
		return (URL_API_BASE + "?" + super.toQueryString(KEYS_PARAM));
	}

	// EXECUTE
	@Override
	public WxmpResponseBase execute() throws IOException {
