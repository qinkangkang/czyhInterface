...
import com.github.cuter44.wxmp.resps.GroupsCreateResponse;
...
public class GroupsCreate extends WxmpRequestBase {
	...
	public static final JSONObject BODY_SCHEMA = JSON.parseObject("{" + "'properties':{" + "'group':{"
			+ "'type':'object'," + "'schema':{" + "'properties':{" + "'name':{'type':'string',}" + "} } } } }");
	...
	// EXECUTE
	@Override
	public GroupsCreateResponse execute() throws IOException {
