...
public abstract class WxmpRequestBase {
	...
	protected static JSONObject buildJSONBody(JSONObject schema, Properties p) {
		return (JSONMaterializer.instance.materialize(schema, p));
	}
	 ...
	 */
	public abstract WxmpResponseBase execute() throws IOException, WxmpException, UnsupportedOperationException;

	/**
	 */
	public String executeGet(String fullURL) throws IOException {
	...
	public String executePostJSON(String fullURL, String bodyJSON) throws IOException {
		...
		req.setEntity(new StringEntity(bodyJSON, ContentType.create("application/json", "utf-8")));
	...
	public String executePostJSON(String fullURL, JSONObject bodyJSON) throws IOException {
		return (this.executePostJSON(fullURL, bodyJSON.toString()));
	}
