 ...
 * OAuth2.0验证接口 <br />
 * <a href=
 * "http://qydev.weixin.qq.com/wiki/index.php?title=%E4%B8%BB%E5%8A%A8%E8%B0%83%E7%94%A8#OAuth2.0.E9.AA.8C.E8.AF.81.E6.8E.A5.E5.8F.A3.E8.AF.B4.E6.98.8E">
 * ref ↗</a> <br />
 * 
 ...
 * 
 * <br />
 * Notice that this request composer does NOT urlencoded the
 * <code>redirect_uri</code>
 */
public class Oauth2Authorize extends WxmpRequestBase {
	// KEYS
	protected static final List<String> KEYS_PARAM = Arrays.asList("appid", "redirect_uri", "response_type", "scope",
			"state");
	...
	public Oauth2Authorize(String appid, String redirectUri) {
		...
		super.setProperty(KEY_APPID, appid).setProperty(KEY_REDIRECT_URI, redirectUri);
	...
	@Override
	public String toURL() {
		return (URL_API_BASE + "?" + super.toQueryString(KEYS_PARAM) + "#wechat_redirect");
	}

	// EXECUTE
	@Override
	public WxmpResponseBase execute() throws UnsupportedOperationException {
		throw (new UnsupportedOperationException("This request does not execute on server side."));
	}
}
