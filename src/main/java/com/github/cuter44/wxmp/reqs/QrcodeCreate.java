...
import com.github.cuter44.wxmp.resps.QrcodeCreateResponse;

/**
 * 创建二维码ticket <br />
 * <a href=
 * "http://mp.weixin.qq.com/wiki/18/28fc21e7ed87bec960651f0ce873ef8a.html#.E5.88.9B.E5.BB.BA.E4.BA.8C.E7.BB.B4.E7.A0.81ticket">
 * ref ↗</a> <br />
 * 
...
public class QrcodeCreate extends WxmpRequestBase {
	// KEYS
	protected static final List<String> KEYS_PARAM = Arrays.asList("access_token");
	...
	public static final JSONObject BODY_SCHEMA = JSON
			.parseObject("{" + "'properties':{" + "'action_name':{'type':'string'},"
					+ "'expire_seconds':{'type':'integer'}," + "'action_info':{" + "'type':'object'," + "'schema':{"
					+ "'properties':{" + "'scene':{" + "'type':'object'," + "'schema':{" + "'properties':{"
					+ "'scene_id':{'type':'integer'}," + "'scene_str':{'type':'string'}" + "} } } } } } } }");
	...
	// EXECUTE
	@Override
	public QrcodeCreateResponse execute() throws IOException {
	...
	public String getActionName() {
		return (super.getProperty(KEY_ACTION_NAME));
	}
