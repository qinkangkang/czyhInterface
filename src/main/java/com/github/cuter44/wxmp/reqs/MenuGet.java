...
import com.github.cuter44.wxmp.resps.MenuGetResponse;

/**
 * 自定义菜单查询接口 <br />
 * <a href=
 * "http://mp.weixin.qq.com/wiki/16/ff9b7b85220e1396ffa16794a9d95adc.html">ref
 * ↗</a> <br />
 */
public class MenuGet extends WxmpRequestBase {
	...
	// EXECUTE
	@Override
	public MenuGetResponse execute() throws IOException {
