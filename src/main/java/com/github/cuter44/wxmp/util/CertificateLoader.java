...
public class CertificateLoader {
	...
	public CertificateLoader loadIdentification(String resourcePath, String passphrase) {
		try {
			...
			if (stream == null)
				throw (new MissingResourceException("Load identification failed.", CertificateLoader.class.getName(),
						resourcePath));
	...
	public static void main(String[] args) {
		try {
			InputStream stream = CertificateLoader.class.getResourceAsStream("/wxpay.properties");
