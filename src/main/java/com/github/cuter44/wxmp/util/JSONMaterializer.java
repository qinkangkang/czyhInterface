...
import com.github.cuter44.nyafx.servlet.PrimitiveParsers.DoubleParser;
import com.github.cuter44.nyafx.servlet.PrimitiveParsers.LongParser;
import com.github.cuter44.nyafx.servlet.PrimitiveParsers.StringParser;
import com.github.cuter44.nyafx.servlet.ValueParser;

/**
 * A lite json schema materializer implemention for building wxmp/wxmp reqs'
 * json body.
 * 
 * @since 0.7.0.0
 */
	...
	public JSONObject materialize(JSONObject jsonSchema, Properties p) {
		...
		for (String k : nodes.keySet()) {
			...
			if ("object".equals(t)) {
				...
				v = this.parsers.get(t).parseString(p.getProperty(k), null);
			}
