...
public class SnsUserinfoResponse extends WxmpResponseBase {
	...
	public String getNickname() {
		return (super.getProperty(KEY_NICKNAME));
	}

	public String getHeadimgurl() {
		return (super.getProperty(KEY_HEADIMGURL));
	}

	public BufferedImage getHeadimg() throws IOException {
		try {
			return (ImageIO.read(new URL(this.getHeadimgurl())));
