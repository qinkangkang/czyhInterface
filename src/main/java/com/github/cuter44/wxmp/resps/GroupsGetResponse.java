 ...
 * </pre>
 */
public class GroupsGetResponse extends WxmpResponseBase implements Iterable<GroupsGetResponse.Group> {
	// CONSTANTS
	 ...
	 */
	@Override
	public JSONObject getJson() throws UnsupportedOperationException {
	...
	public class GroupsIterator implements Iterator<Group> {
		Iterator<Object> i;
