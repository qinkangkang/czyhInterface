...
public class UserInfoResponse extends SnsUserinfoResponse {
	...
	public Boolean getSubscribe() {
		return ("1".equals(super.getProperty(KEY_SUBSCRIBE)));
	}

	public Date getSubscribeTime() {
		return (new Date(Long.valueOf(super.getProperty(KEY_SUBSCRIBE_TIME)) * 1000L));
	}

	public Integer getGroupid() {
		return (Integer.valueOf(super.getProperty(KEY_SUBSCRIBE_TIME)));
	}
