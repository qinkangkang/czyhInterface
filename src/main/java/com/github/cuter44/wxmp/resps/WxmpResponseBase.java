...
public class WxmpResponseBase {
	...
	public WxmpResponseBase(String jsonString) throws WxmpException {
	...
	public final Integer getInteger(String key) {
		return (this.json.getInteger(key));
	}
	...
	public final Integer getErrcode() {
		return (this.getInteger(KEY_ERRCODE));
	}

	public final String getErrmsg() {
		return (this.getString(KEY_ERRMSG));
	}
}
