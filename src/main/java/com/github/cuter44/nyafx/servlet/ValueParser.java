...
public interface ValueParser<T> {
	 ...
	 * 
	 * @param valueToParse
	 *            Value to be parsed, may comes from
	 *            parameter/request/session/cookies, so it can be various type
	 *            but mostly String, then likely to be numeric.
	 * @param type
	 *            The expecting returned class, may be null.
	...
	public static interface ArrayParser<T> extends ValueParser {
		 ...
		 * @param valueToParse
		 *            Value to be parsed, may comes from
		 *            parameter/request/session/cookies, so it can be various
		 *            type but mostly String, then likely to be numeric.
		 * @param componentType
		 *            The expecting returned class of array component, may be
		 *            null.
		 * @return The parsed object.
		 */
		@Override
	...
	public static interface ListParser<T> extends ValueParser {
		 ...
		 *            type but mostly String, then likely to be numeric.
		 * @param componentType
		 *            The expecting returned class of element, may be null.
		 * @return The parsed object.
		 */
		@Override
