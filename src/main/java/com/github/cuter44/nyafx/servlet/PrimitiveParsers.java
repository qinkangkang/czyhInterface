...
public class PrimitiveParsers {
	...
	public static class StringArrayParser implements ValueParser.ArrayParser<String> {
		...
		@Override
		public String[] parseString(String v, Type type) {
			return (v.split(this.regexSeperator));
		}
	...
	public static class StringListParser implements ValueParser.ListParser<String> {
		public static StringArrayParser instance = new StringArrayParser();
		...
		public List<String> parseString(String v, Type type) {
			return (this.parseStringArray(StringArrayParser.instance.parseString(v, String[].class), List.class));
		}
	...
	public static class ByteArrayParser implements ValueParser.ArrayParser<Byte> {
		...
		@Override
		public Byte[] parseString(String v, Type type) {
			return (this.parseStringArray(StringArrayParser.instance.parseString(v, String.class), Byte.class));
		}
	...
	public static class ByteListParser implements ValueParser.ListParser<Byte> {
		...
		public List<Byte> parseString(String v, Type type) {
			return (Arrays.asList(ByteArrayParser.instance.parseString(v, Byte.class)));
		}

		@Override
		public List<Byte> parseStringArray(String[] v, Type type) {
			return (Arrays.asList(ByteArrayParser.instance.parseStringArray(v, Byte.class)));
		}
	}
	...
	public static class IntArrayParser implements ValueParser.ArrayParser<Integer> {
		...
		@Override
		public Integer[] parseString(String v, Type type) {
			return (this.parseStringArray(StringArrayParser.instance.parseString(v, String.class), Integer.class));
		}
	...
	public static class IntListParser implements ValueParser.ListParser<Integer> {
		...
		public List<Integer> parseString(String v, Type type) {
			return (Arrays.asList(IntArrayParser.instance.parseString(v, Integer.class)));
		}

		@Override
		public List<Integer> parseStringArray(String[] v, Type type) {
			return (Arrays.asList(IntArrayParser.instance.parseStringArray(v, Integer.class)));
		}
	}
	...
	public static class LongArrayParser implements ValueParser.ArrayParser<Long> {
		...
		@Override
		public Long[] parseString(String v, Type type) {
			return (this.parseStringArray(StringArrayParser.instance.parseString(v, String.class), Long.class));
		}
	...
	public static class LongListParser implements ValueParser.ListParser<Long> {
		...
		public List<Long> parseString(String v, Type type) {
			return (Arrays.asList(LongArrayParser.instance.parseString(v, Long.class)));
		}

		@Override
		public List<Long> parseStringArray(String[] v, Type type) {
			return (Arrays.asList(LongArrayParser.instance.parseStringArray(v, Long.class)));
		}
	}
	...
	public static class FloatArrayParser implements ValueParser.ArrayParser<Float> {
		...
		@Override
		public Float[] parseString(String v, Type type) {
			return (this.parseStringArray(StringArrayParser.instance.parseString(v, String.class), Float.class));
		}
	...
	public static class FloatListParser implements ValueParser.ListParser<Float> {
		...
		public List<Float> parseString(String v, Type type) {
			return (Arrays.asList(FloatArrayParser.instance.parseString(v, Float.class)));
		}

		@Override
		public List<Float> parseStringArray(String[] v, Type type) {
			return (Arrays.asList(FloatArrayParser.instance.parseStringArray(v, Float.class)));
		}
	}
	...
	public static class DoubleArrayParser implements ValueParser.ArrayParser<Double> {
		...
		@Override
		public Double[] parseString(String v, Type type) {
			return (this.parseStringArray(StringArrayParser.instance.parseString(v, String.class), Double.class));
		}
	...
	public static class DoubleListParser implements ValueParser.ListParser<Double> {
		...
		public List<Double> parseString(String v, Type type) {
			return (Arrays.asList(DoubleArrayParser.instance.parseString(v, Double.class)));
		}

		@Override
		public List<Double> parseStringArray(String[] v, Type type) {
			return (Arrays.asList(DoubleArrayParser.instance.parseStringArray(v, Double.class)));
		}
	}
	...
	public static class BooleanArrayParser implements ValueParser.ArrayParser<Boolean> {
		...
		@Override
		public Boolean[] parseString(String v, Type type) {
			return (this.parseStringArray(StringArrayParser.instance.parseString(v, String.class), Boolean.class));
		}
	...
	public static class BooleanListParser implements ValueParser.ListParser<Boolean> {
		...
		public List<Boolean> parseString(String v, Type type) {
			return (Arrays.asList(BooleanArrayParser.instance.parseString(v, Boolean.class)));
		}

		@Override
		public List<Boolean> parseStringArray(String[] v, Type type) {
			return (Arrays.asList(BooleanArrayParser.instance.parseStringArray(v, Boolean.class)));
		}
	}
	...
	public static class DateArrayParser implements ValueParser.ArrayParser<Date> {
		...
		@Override
		public Date[] parseString(String v, Type type) {
			return (this.parseStringArray(StringArrayParser.instance.parseString(v, String.class), Date.class));
		}

		@Override
		public Date[] parseStringArray(String[] v, Type type) {
			return (this.parseLongArray(LongArrayParser.instance.parseStringArray(v, String.class), Long.class));
		}
	...
	public static class DateListParser implements ValueParser.ListParser<Date> {
		...
		public List<Date> parseString(String v, Type type) {
			return (Arrays.asList(DateArrayParser.instance.parseString(v, Date.class)));
		}

		@Override
		public List<Date> parseStringArray(String[] v, Type type) {
			return (Arrays.asList(DateArrayParser.instance.parseStringArray(v, Date.class)));
		}
	}
