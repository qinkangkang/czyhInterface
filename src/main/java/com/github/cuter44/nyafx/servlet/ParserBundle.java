...
public class ParserBundle implements ValueParser {
	...
	/**
	 * As there is no mean for bundle to recognize a List<Type> (excpet
	 * iterating the whole map), it is currently unable to parse Lists
	 */
